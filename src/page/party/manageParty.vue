                        ...
                        <el-form
                            ...
                            <el-form-item>
                                <el-button type="primary" size="mini" icon="el-icon-plus"
                                           @click='_preInsertRootPartyOrg'
                                >添加根节点
                                </el-button>
                                <el-button type="primary" size="mini" icon="el-icon-plus" @click='_preInsertSubPartyOrg'
                                           :disabled="BUTTON_STATUS.preInsertSubPartyOrgButton"
                                >添加子节点
                                </el-button>
                                <el-button type="primary" size="mini" icon="el-icon-edit-outline"
                                           @click='_preUpdatePartyOrg' :disabled="BUTTON_STATUS.preUpdatePartyOrgButton"
                                >编辑
                                </el-button>
                                <el-button type="danger" size="mini" icon="el-icon-delete" @click='_deletePartyOrg'
                                           :disabled="BUTTON_STATUS._deletePartyOrgButton"
                                >删除
                                </el-button>
                            </el-form-item>
                        </el-form>
                ...
                <div class="grid-content "><!--Emp-->
                    <div><!--按钮区-->
                        <el-form
                            ...
                            <el-form-item>
                                员工名称:
                                <el-input v-model="party_Query_Date.PARTY_NAME_" style="width: 200px"
                                          placeholder="请输入员工名称"
                                          clearable>
                                </el-input>
                            </el-form-item>
                            <el-form-item>
                                ...
                                <el-button type="primary" size="mini" icon="el-icon-plus" @click='_preInsertEmp'
                                           :disabled="BUTTON_STATUS._preInsertEmpButton"
                                >添加
                                </el-button>
                                <el-button type="danger" size="mini" icon="el-icon-delete" @click='_deleteEmpParty'
                                           :disabled="BUTTON_STATUS._deleteEmpPartyButton"
                                >删除
                                </el-button>
                            </el-form-item>
                        </el-form>
...
<script>
	...
	import insertRootOrgParty from './preInsertRootOrgParty.vue';
	/*引用新增根机构页面*/
	import insertSubOrgParty from './preInsertSubOrgParty.vue';
	/*引用新增子机构页面*/
	import updateOrgParty from './preUpdateOrgParty.vue';
	/*引用新增子机构页面*/
	...
	export default {
		...
		data() {
			return {
				mainloading: false,//机构加载限制
				filterText: '',
				filterEmp: '',
				idFlag: false,
				org: {
					/*点击机构名称时，值传入这里，目的是调用其它页面传值*/
					PARTY_ID_: '',
					PARENT_PARTY_ID_: '',
					PARTY_CODE_: '',
					PARTY_NAME_: '',
